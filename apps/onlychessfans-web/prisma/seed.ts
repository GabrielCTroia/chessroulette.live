    ...
    create: {
      ...
      posts: {
        create: [
          {
            type: 'FEN',
            content: 'rnbq1bnr/pppppppp/8/P7/2R5/8/1PPPPPPP/RNBkKBN1',
          },
          {
            type: 'PGN',
            content: `[Event "50th Sparkassen Open A"]
            [Site "Dortmund GER"]
            [Date "2023.07.02"]
            [Round "9.3"]
            [White "Adams,Mi"]
        ...
        create: [
          {
            type: 'FEN',
            content:
              '2k4r/1p1p1ppp/p7/4nB2/4p3/P3PnP1/1PPq1P1P/R2K3R w - - 0 19',
          },
        ],
      },
    },
  });
  console.log({ gabe, bob });
}
main()
  .then(async () => {
